...
<body>
    ...
    <section class="home">
        ...
        <div class="row">
            ...
            <h1 class="text">  Crea un Requisito </h1>
        </div>
        <br>
            ...
            <form action="/ProyectoElectiva/app/controllers/RulesController.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="campos">
                        ...
                        <div class="campo">
                            ...
                            <input type="text" name="requirement_description" id="requirement_description" required> 
                        </div>
                    ...
                    <div class="botons">
                        ...
                        <input id="send-btn" class="btn-succ" type="submit"  value="Guardar Requisito">
                    </div>
            </form>
