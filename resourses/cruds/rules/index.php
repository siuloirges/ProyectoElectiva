    ...
    <section class="home">
        ...
        <table class="table scroll-box" >
                ...
                <tr class='cols scroll-box'>
                    ...
                    <td class="col" class="scroll-box" >Descripcion del requisito </td>
    ...
    <script>
         function deleteById(id){
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = "http://localhost/ProyectoElectiva/app/controllers/RulesController.php?action=delete&id="+id;
