...
<body>
    ...
    <section class="home">
        ...
        <div class="form-contain">
            ...
            <hr>
            <form action="/ProyectoElectiva/app/controllers/CDCController.php" method="post" enctype="multipart/form-data">
                
                    <div class="campos">

                        <div class="campo">
                            <span> Nombre</span>
                            <input value="<?php echo  @$_SESSION['cdc']->name ?>" type="text" name="name" id="name" required> 
                        </div>
        
                        <div class="campo">
                            <span>  Descripcion del Ensayo </span>
                            <input type="text" value="<?php echo  @$_SESSION['cdc']->description ?>" name="description" id="description" required> 
                        </div>
                    ...
                    <div class="botons">
                        ...
                        <input id="send-btn" class="btn-succ" type="submit"  value="Actualizar CDC">
                    </div>
            </form>
