            ...
            <form action="/ProyectoElectiva/app/controllers/EssaysController.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="campos">
                        ...
                        <div class="campo">
                            ...
                            <input type="text" value="<?php echo  @$_SESSION['essay']->description ?>" name="description" id="description" required> 
                        </div>
                    ...
                    <div class="botons">
                        ...
                        <input id="send-btn" class="btn-succ" type="submit"  value="Actualizar Ensayo">
                    </div>
            </form>
